...
/**
 * This font implements a 7x10 pixel character set to write text to the SH1106 OLED Display
 *
 * @author Roland Baudouin
 */
public class DotMatrixFont7x10 extends DotMatrixFont {
	private static final int fontWidth = 7;
	private static final int fontHeight = 10;
	private static final int spaceWidth = 1;
	private static final int bytesPerChar = 10;
	private static final byte startChar = 0x20;
	private static final byte stopChar = 0x7E;
	private static final FONT_SCAN_MODE scanMode = FONT_SCAN_MODE.FONT_SCAN_H;
